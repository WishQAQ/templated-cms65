...
class ListView
{
    ...
    function GetPageListST($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".str_replace("{page}",$prepagenum,$tnamerule)."' style=\"width: 100px;\">上一页</a>\r\n";
            $indexpage="<li><a href='".str_replace("{page}",1,$tnamerule)."'>首页</a></li>\r\n";
        }
        else
        {
			$prepage.="<span><a style=\"width: 100px;\">上一页</a></span>\r\n";
            $indexpage="<li>首页</li>\r\n";
        }
        ...
        {
            $nextpage.="<a href='".str_replace("{page}",$nextpagenum,$tnamerule)."' style=\"width: 100px;\">下一页</a>\r\n";
            $endpage="<li><a href='".str_replace("{page}",$totalpage,$tnamerule)."'>末页</a></li>\r\n";
        }
        else
        {
			$nextpage.="<span><a style=\"width: 100px;\">下一页</a></span>\r\n";
            $endpage="<li>末页</li>\r\n";
        }
    ...
    function GetPageListDM($list_len,$listitem="index,end,pre,next,pageno")
    {
        ...
        if($this->PageNo != 1)
        {
            $prepage.="<a href='".$purl."PageNo=$prepagenum' style=\"width: 100px;\">上一页</a>\r\n";
        ...
        if($this->PageNo!=$totalpage && $totalpage>1)
        {
            $nextpage.="<a href='".$purl."PageNo=$nextpagenum' style=\"width: 100px;\">下一页</a>\r\n";
        ...
        for($j;$j<=$total_list;$j++)
        {
            if($j==$this->PageNo)
            {
                $listdd.= "<span class=\"current\"><a>$j</a></span>\r\n";
            }
            else
            {
